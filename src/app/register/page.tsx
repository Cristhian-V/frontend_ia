    ...
    <div className="flex min-h-screen items-center justify-center bg-faro-bg px-4">
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="rounded-xl bg-faro-surface border border-faro-border p-6 shadow-xl">
          <h2 className="mb-4 text-lg font-semibold text-faro-textlight">Crear cuenta</h2>
          ...
          <div className="mb-3">
            <label className="mb-1 block text-sm font-medium text-faro-text">Nombre completo</label>
            <input
              type="text"
              value={name}
